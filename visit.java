...
public class visit {
    ...
    @Override
     public String toString(){
         return "visit{" + "customer name = " + name.getName() + "customer member = " +
                 name.isMember() + " customer member type = " + name.getMemberType()+
                 " date : " + date + " serviceExpense = " + serviceExpense + " productExpense = "+
                 productExpense;
     }
}
